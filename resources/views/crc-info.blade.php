...
<body>
    ...
    <!-- <div class="container-fluid bg-breadcrumb">
        <div class="container text-center py-5" style="max-width: 900px;">
            <h3 class="text-white display-7 mb-4 wow fadeInDown" data-wow-delay="0.1s">CRC Templates & Guidelines</h3>
            <ol class="breadcrumb justify-content-center text-white mb-0 wow fadeInDown" data-wow-delay="0.3s">
                <li class="breadcrumb-item"><a href="./" class="text-white">Home</a></li>
                <li class="breadcrumb-item"><a href="#" class="text-white">Pages</a></li>
                <li class="breadcrumb-item active text-secondary">CRC Templates & Guidelines</li>
            </ol>    
        </div>
    </div> -->
    <!-- Header End -->
    ...
    <div class="container-fluid pb-5 service overflow-hidden">
        <div class="container py-5">
            <div class="section-title text-center mb-5 wow fadeInUp" data-wow-delay="0.1s">
                ...
                <h2 class="display-7 mb-4">CRC Templates & Guidelines</h1>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row g-5">
                <div class="col-md-12 wow fadeInRight" data-wow-delay="0.3s">
                    ...
                    <h3 class="display-7 mb-4">Springer CRC Templates for Download</h3>
                </div>                    
                <div class="col-md-12 wow fadeInRight" data-wow-delay="0.3s">                    
                    <!-- <H5 class="py-2"><A class="text-secondary" href="https://www.springer.com/gp/computer-science/lncs/conference-proceedings-guidelines">Template Download Links</A></H5> -->
                ...
                <div class="col-md-12 wow fadeInRight" data-wow-delay="0.3s">
                    <h5 class="sub-title pe-3">{!!env('CONF_NAME')!!}</h5>
                    <h3 class="display-7 mb-4">Editorial Guidelines for Preparation of Camera Ready Copy (CRC)</h3>
                    <div class="ms-3">
