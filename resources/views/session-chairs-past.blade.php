    ...
    <div class="container-fluid country overflow-hidden py-5">
        <div class="container pt-5">
            <div class="section-title text-center wow fadeInUp mb-5 pb-5" data-wow-delay="0.1s">
                ...
                <h2 class="display-7 mb-4">Past Session Chairs</h2>
            </div>
        </div>
        ...
        <div class="container pb-5">            
            <div class="row g-4 text-center">
                @php
                    $data = Config::get('app.past-session-chairs');
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 my-5 mb-xl-0 wow fadeInUp" data-wow-delay="0.1s"> 
                    <div class="country-item my-3">
                        <div class="rounded overflow-hidden bg-light" style="height: 250px">
                        ...
                        <div class="country-flag" style="height: 150px; width: 150px">
                            <img src="public/assets/img/speakers/past-session-chairs/{!!$d['name']!!}.jpg" class="img-fluid rounded-circle" alt="Image">
                        </div>
                    </div>
                </div>
                @endforeach
